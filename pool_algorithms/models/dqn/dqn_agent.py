...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = nn_model.QNetwork(state_size, action_size, seed).to(device)
        self.qnetwork_target = nn_model.QNetwork(state_size, action_size, seed).to(device)
